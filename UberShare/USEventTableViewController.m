...
@implementation USEventTableViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    NSLog(@"events from table %@", self.events);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    GTLCalendarEvent* list = self.events[indexPath.row];
